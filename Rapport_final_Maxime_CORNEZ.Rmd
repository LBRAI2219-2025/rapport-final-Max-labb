...
date: "2025-05-24"
bibliography: ressources/LBRAI2219.bib         #document bibliographique
csl: ressources/apa-annotated-bibliography.csl # style de citation
#nocite:     |
#  @*
output:
...
2.  Obtention des paramètres météo, soit via un jeu de données généré artificiellement, soit via un jeu de données réelles obtenu via Open-Meteo [@open-meteo__nodate] ; sélection de la source via le switch installé dans le code.
